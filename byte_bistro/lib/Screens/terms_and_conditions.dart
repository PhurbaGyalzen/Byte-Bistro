...
class TermsAndCondition extends StatelessWidget {
  ...
  var data = [
    ...
    },
    {
      ...
      "description":
          "Orders will be taken online. Our app provide wide range of visual satisfaction to the user that generally helps them to recognize the new item via tabulated pictures and price. Transaction is very easy in comparison to other app available in the market. . Buyers are usually billed directly by merchant members for their orders, and 'FoodGanj' will be the name that appears on the bills you receive from the merchants. You need to pay for the ordered food either by online payments like eSewa, khalti, fonepay, and others available in present days; or by paying cash to delivery staff depending on user’s choice."
    },
    {
      "title": "REFUND POLICY",
      "description":
          "FoodGanj always looks forward for customer satisfaction regarding services. In the case of problems with your food order, please contact us. In only appropriate cases, FoodGanj will issue full or partial refunds. For example: if you did not receive your order or received an incorrect order, you may be issued a full refund; if part of your order is missing, we may issue a partial refund. In every event, we will do our best to ensure your satisfaction."
    },
    {
      "title": "Sale of Alcohol",
      "description":
          "Persons who place an order for alcohol from our connected restaurants must be strictly aged 18 or above. Each and every alcoholic beverages will be easily sold or delivered to the persons only by authenticating their age. For authentication, user will be asked about the proof of their ages. FoodGanj holds the right to decline the order of any alcoholic beverages to any person who is under the influence of either alcohol or drugs."
    },
    {
      "title": "Cancellation",
      "description":
          "You have the right to cancel an order within a reasonable time and before the order is prepared. The cancellation process can only be determined by FoodGanj. It depends upon time interval from confirm food to cancellation time."
    },
    {
      "title": "Termination",
      "description":
          "FoodGanj also holds the right to terminate membership of any customer or partner restaurant owner if some irresponsible or bad behaviour is done to FoodGanj. In case of any legal disputes, user or restaurant owner are entitled to bear all the costs which is needed during procedure."
    }
  ];
